  ...
  return (
    <div className="container">
      ...
      <main className="grid">
        ...
        {/* Card 6: System Security Card */}
        <div className="demo-unit">
          <div className="unit-top-bar">
            <span className="unit-title">6. System Security Card</span>
            <button
              type="button"
              className="unit-toggle-pill"
          ...
          <AutoSkeleton loading={cardLoading.ignore} animate={animateMode}>
            <div className="real-card">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <h4 style={{ fontWeight: 700, fontSize: "1.1rem" }}>System Security Status</h4>
                <span className="badge-tag" style={{ background: "rgba(16, 185, 129, 0.2)", color: "#6ee7b7" }}>
                  Protected
                </span>
              </div>
              <p style={{ color: "var(--text-muted)", fontSize: "0.9rem" }}>
                Continuous vulnerability scanning and automated patch deployment across all production microservices.
              </p>
